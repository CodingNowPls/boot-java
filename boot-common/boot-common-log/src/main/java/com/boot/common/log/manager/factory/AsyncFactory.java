package com.boot.common.log.manager.factory;
...
import com.boot.common.core.utils.LogUtils;
    ...
    public static TimerTask recordLogininfor(final String username, final String status, final String message,
        ...
        return new TimerTask() {
            ...
            public void run() {
                ...
                // 插入数据
                SpringUtils.getBean(SystemApi.class).insertLogininfor(logininfor);
            }
        };
    }
    ...
    public static TimerTask recordOper(final SysOperLog operLog) {
        return new TimerTask() {
            ...
            public void run() {
                ...
                SpringUtils.getBean(SystemApi.class).insertOperlog(operLog);
            }
        };
    }
}
