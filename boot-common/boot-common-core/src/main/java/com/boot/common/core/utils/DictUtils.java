...
public class DictUtils {
    ...
    public static void setDictCache(String key, List<SysDictData> dictDatas) {
        SpringUtils.getBean(BootCache.class).setCacheObject(getCacheKey(key), dictDatas);
    }
    ...
    public static List<SysDictData> getDictCache(String key) {
        Object cacheObject = SpringUtils.getBean(BootCache.class).getCacheObject(getCacheKey(key));
    ...
    public static void removeDictCache(String key) {
        SpringUtils.getBean(BootCache.class).deleteObject(getCacheKey(key));
    }
    ...
    public static void clearDictCache() {
        Collection<String> keys = SpringUtils.getBean(BootCache.class).keys(CacheConstants.SYS_DICT_KEY + "*");
        SpringUtils.getBean(BootCache.class).deleteObject(keys);
    }
